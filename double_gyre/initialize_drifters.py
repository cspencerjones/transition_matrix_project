...
def createParticlesNC(fnam,ids,ines,jnes,lons,lats,slons,slats,levs,days):
...
createParticlesNC('drifters.res.nc',ids=id_list,ines=ines_list ,jnes=jnes_list,lons=lons_list,lats=lats_list,slons=lons_list,slats=lats_list,levs=levs_list,days=days_list)
